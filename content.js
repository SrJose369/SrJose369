...
function refre() {
	...
	try {
		if (cual[12] === "y") {
			...
			//a = document.querySelector("#movie_player > div.ytp-chrome-bottom > div.ytp-chrome-controls > div.ytp-left-controls > div.ytp-time-display.notranslate > span:nth-child(2) > span.ytp-time-current");
			a = document.getElementsByClassName("ytp-time-current")[0];
			// nombre canal
			...
			if (cual[12] === "t") {
				...
				b = document.getElementsByClassName("CoreText-sc-cpl358-0 ScTitleText-sc-1gsen4-0 fWkOCC bMnEsX InjectLayout-sc-588ddc-0 gCPoAo tw-title")[0];
				// titulo video
